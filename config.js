...
const STEPS = [
  ...
  { id: 3,  title: "投稿計画・スケジューリング", description: "投稿スケジュールと計画を立てる。",                                                           estimatedMinutes: 30, allowedLevels: ["beginner","mid","pro"],       hasBrandCheck: false, skipReason: "投稿スケジュールが確定している場合はスキップ可" },
  { id: 4,  title: "素材・キャラクター準備", description: "必要な素材やキャラクター設定などの事前準備を行う。",                                              estimatedMinutes: 40, allowedLevels: ["beginner","mid","pro"],       hasBrandCheck: true,  skipReason: "必要な素材が全て揃っている場合はスキップ可" },
  ...
  { id: 6,  title: "映像・動画素材生成",     description: "音声や台本に合わせ、映像や動画素材を生成する。",                                                   estimatedMinutes: 45, allowedLevels: ["beginner","mid","pro"],       hasBrandCheck: true,  skipReason: null },
  { id: 7,  title: "ナレーション・音声生成", description: "台本をもとに、AIを使用してナレーションや音声を生成する。",                                         estimatedMinutes: 20, allowedLevels: ["beginner","mid","pro"],       hasBrandCheck: true,  skipReason: null },
